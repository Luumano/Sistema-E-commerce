...
namespace SistemaGestaoPedidos.AcceptanceTests.Features.Steps
{
	...
	public class PedidoSteps
	{
		...
		public void DadoQueUmClienteChamadoDesejaFazerUmPedido(string nome)
		{
		...
		public void QuandoEleAdicionaOsSeguintesItensAoPedido(Table table)
		{
		...
		public void QuandoEleConfirmaOPedido()
		{
			_pedido.ConfirmarPedido();
		}

		[Then(@"o pedido deve ter o status ""(.*)""")]
		public void EntaoOPedidoDeveTerOStatus(string statusEsperado)
		{
